...
public enum Location implements Serializable {
    ...
    OutsideNorthGate(0,2,2,4,"North Gate to Edinburg"),
    CityCenterNorthGate(1,1,4,1,"Inside North Gate to Edinburg"),
    CityCenterBedimes(1,2,5,2,"A noble couple and their servant"),
    CityCenterEastGate(1,3,9,4,"Gate to Slums"), 
    CityCenterSouthGate(1,4,7,9,"Gate to Merchant District"),
    CityCenterWestGate(1,5,0,7,"Gate to Government District"),
    CityCenterStore(1,6,2,3,"Samuel's Smith & Sundries"),
    CityCenterPub(1,7,4,4,"Lazy Lion Pub");
